...
abstract class Model
{
    ...
    public function __get($name)
    {
        if (isset($this->attributes[$name])) {
            return $this->attributes[$name];  // @TODO: Return the value from attributes for $name if it exists, else return null    
        } else {
            return null;
        }        
    }
    ...
    public function save()
    {
        ...
        // @TODO: Ensure there are values in the attributes array 
        //before attempting to save

        // @TODO: Call the proper database method: 
